            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
              <div className="max-w-2xl">
                ...
                <p className="text-base text-gray-600 leading-relaxed">
                  Gérez vos avoirs sur factures d&apos;acompte. Créez facilement des remboursements 
                  ou des modifications pour les acomptes déjà versés par vos clients.
                </p>
              </div>
              
              <div className="flex items-center bg-[#1B0353]/5 p-3 rounded-xl">
                <FiFileText className="w-6 h-6 text-[#1B0353]" />
                <span className="ml-2 text-[#1B0353] font-medium">Gestion des avoirs d&apos;acompte</span>
              </div>
            </div>
            ...
            <div className="mt-6 flex items-start gap-2 p-3 bg-purple-50 border border-purple-100 rounded-xl text-sm">
              ...
              <div>
                ...
                <span className="text-purple-700">
                  Les avoirs d&apos;acompte sont liés aux factures d&apos;acompte correspondantes. 
                  Assurez-vous de spécifier la facture d&apos;acompte concernée lors de la création d&apos;un avoir.
                </span>
              </div>
            </div>
          </div>
