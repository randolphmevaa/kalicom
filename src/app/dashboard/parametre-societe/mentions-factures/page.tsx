...
export default function MentionsLegalesDesFactures() {
  // State for legal text
  const [legalText, setLegalText] = useState<string>(
    "Escompte pour règlement anticipé: 0%<br>" +
    "En cas de retard de paiement, une pénalité égale à 3 fois le taux d'intérêt légal sera exigible (Arrêté du 26 décembre 2021 - article L.441-10 du Code de Commerce)<br>" +
  ...
  const handleResetToDefault = (): void => {
    if (window.confirm('Êtes-vous sûr de vouloir réinitialiser le texte par défaut?')) {
      const defaultText = "Escompte pour règlement anticipé: 0%<br>" +
        "En cas de retard de paiement, une pénalité égale à 3 fois le taux d'intérêt légal sera exigible (Arrêté du 26 décembre 2021 - article L.441-10 du Code de Commerce)<br>" +
        "Pour les professionnels, une indemnité forfaitaire de 40€ pour frais de recouvrement sera exigible (article D. 441-5 du Code de commerce)";
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
              <div className="max-w-2xl">
                ...
                <p className="text-base text-gray-600 leading-relaxed">
                  Personnalisez les mentions légales de vos factures. Ces mentions apparaîtront sur tous vos documents de facturation.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Mentions légales des factures</h2>
              </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-700">
                        Les mentions légales sur vos factures sont obligatoires selon la législation française. 
                        Elles doivent notamment inclure les informations sur les pénalités de retard, les conditions d&apos;escompte et 
                        l&apos;indemnité forfaitaire pour frais de recouvrement. Ces mentions permettent de protéger juridiquement votre entreprise 
                        en cas de litige et informent vos clients de leurs obligations.
                      </p>
                    </div>
                  </div>
                </div>
                
                {/* Other Required Mentions */}
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 text-xs text-gray-700">
                      <p className="font-medium mb-1">Entreprises en franchise de TVA</p>
                      <p>&quot;TVA non applicable, art. 293 B du CGI&quot;</p>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 text-xs text-gray-700">
                      <p className="font-medium mb-1">Auto-entrepreneurs</p>
                      <p>&quot;Dispensé d&apos;immatriculation au registre du commerce et des sociétés (RCS) et au répertoire des métiers (RM)&quot;</p>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 text-xs text-gray-700">
                      <p className="font-medium mb-1">Médiateur à la consommation</p>
                      <p>&quot;En cas de litige, vous pouvez déposer votre réclamation sur [site du médiateur]&quot;</p>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 text-xs text-gray-700">
                      <p className="font-medium mb-1">Société avec un capital social</p>
                      <p>&quot;[Forme juridique] au capital de [montant] euros - [RCS et numéro]&quot;</p>
                    </div>
                  </div>
                </div>
              </div>
