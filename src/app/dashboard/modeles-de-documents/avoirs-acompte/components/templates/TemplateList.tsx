...
interface TemplateListProps {
  templates: DepositCreditNoteTemplate[];
              ...
              <div className="flex justify-between items-start">
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className={`font-medium ${selectedId === template.id ? 'text-[#E05D5D]' : 'text-gray-800'}`}>
                      {template.name}
                    </h3>
                ...
                <div className="text-gray-400">
                  <FiChevronRight className={`w-5 h-5 transition-transform ${selectedId === template.id ? 'transform rotate-90 text-[#E05D5D]' : ''}`} />
                </div>
              </div>
            </motion.div>
          ))}
