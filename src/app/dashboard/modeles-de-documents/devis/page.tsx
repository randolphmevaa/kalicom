            ...
            >
              <div className="flex justify-between items-center p-4 border-b">
                <h3 className="text-xl font-bold text-gray-800 flex items-center">
                  <FiFileText className="mr-2 text-[#009B72]" />
                  {currentTemplate?.name}
                </h3>
                <div className="flex gap-3">
                  <button
                    onClick={downloadPdf}
                    className="px-3 py-2 rounded-lg bg-[#009B72]/10 text-[#009B72] hover:bg-[#009B72]/20 transition flex items-center"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded-lg bg-[#009B72] text-white hover:bg-[#008A65] transition flex items-center"
                  >
              ...
              <div className="flex-grow overflow-auto p-6 bg-gray-100 flex items-center justify-center">
                ...
                <div className="w-[650px] bg-white shadow-xl rounded-lg overflow-hidden">
                  {/* PDF Content */}
                  <iframe 
                    src={currentTemplate?.pdfUrl || '/devis-specimen.pdf'}
                            ...
                            <div className="border rounded-xl p-4 bg-white">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                  ...
                                  <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#009B72]/50">
                          ...
                          <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="border rounded-xl p-4 bg-white">
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mb-4">
                                {[
                                  'Total HT', 'Remise', 'Total HT remisé', 'Frais supplémentaires', 
                                  'Total HT Net', 'Total TVA', 'Total TTC', 'Total TTC en lettres',
                                  'Acompte demandé'
                                ].map((item, index) => (
                                  <label key={index} className="flex items-center space-x-2">
                                    <input 
                                      ...
                                      defaultChecked={['Total HT', 'Total TVA', 'Total TTC'].includes(item)}
                                    />
                              ...
                              <div className="border-t pt-3 space-y-2">
                                <label className="flex items-center space-x-2">
                                  <input type="checkbox" className="w-4 h-4 text-[#009B72] rounded focus:ring-[#009B72]" checked />
                            ...
                            <div className="border rounded-xl p-4 bg-white">
                              ...
                              <div className="space-y-3">
                                <label className="flex items-center space-x-2">
                                  <input type="checkbox" className="w-4 h-4 text-[#009B72] rounded focus:ring-[#009B72]" defaultChecked />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="border rounded-xl p-4 bg-white">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                {[
                                  { id: 'frame_color', label: 'Cadre', color: '#009B72' },
                                  { id: 'label_text_color', label: 'Text des intitulés', color: '#FFFFFF' },
                                  { id: 'label_bg_color', label: 'Fond des intitulés', color: '#009B72' },
        ...
        <div className="p-4 border-b border-gray-100">
          <div className="relative">
            <input
              ...
              className="w-full py-2 pl-10 pr-4 text-gray-700 bg-gray-50 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#009B72]/50 focus:border-transparent"
            />
              ...
              <motion.div
                ...
                className={`p-4 rounded-xl cursor-pointer transition-all duration-200 ${
                  selectedTemplate === template.id 
                    ? 'bg-[#009B72]/10 border-l-4 border-[#009B72]' 
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className={`font-medium ${selectedTemplate === template.id ? 'text-[#009B72]' : 'text-gray-800'}`}>
                        {template.name}
                      </h3>
                      {template.isDefault && (
                  ...
                  <div className="text-gray-400">
                    <FiChevronRight className={`w-5 h-5 transition-transform ${selectedTemplate === template.id ? 'transform rotate-90 text-[#009B72]' : ''}`} />
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50">
          <div className="flex justify-between">
            <button 
              ...
              className="text-sm text-gray-600 flex items-center hover:text-[#009B72]"
            >
              {showHiddenTemplates ? (
                <>
