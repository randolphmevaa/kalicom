...
const Step1HeaderStyle = ({ wizardData, updateWizardData }: WizardStepProps) => {
  const headerStyles: HeaderStyleOption[] = [
    { 
      name: 'Standard', 
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        {headerStyles.map((style, index) => (
          <div 
            key={index}
            onClick={() => updateWizardData({ headerStyle: style.name.toLowerCase() })}
...
export default Step1HeaderStyle;