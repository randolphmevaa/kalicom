...
const Step5Formatting = ({ wizardData, updateWizardData }: WizardStepProps) => {
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="border rounded-xl p-4 bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              {[
                { id: 'primaryColor', label: 'Cadre', color: wizardData.formatting.primaryColor },
                { id: 'textColor', label: 'Text des intitulés', color: '#FFFFFF' },
                { id: 'bgColor', label: 'Fond des intitulés', color: wizardData.formatting.primaryColor },
                { id: 'secondaryColor', label: 'Autres textes', color: '#333333' }
              ].map(item => (
        ...
        <div className="border rounded-xl p-4 bg-gray-50 h-fit sticky top-4">
          ...
          <div className="bg-white border border-[#004AC8] rounded-lg p-3 overflow-hidden shadow-sm">
            ...
            <table className="w-full text-xs mb-3">
              <thead>
                <tr>
                  <th style={{ backgroundColor: wizardData.formatting.primaryColor }} className="py-1 px-1 text-white text-left rounded-tl-md">Description</th>
                  <th style={{ backgroundColor: wizardData.formatting.primaryColor }} className="py-1 px-1 text-white text-center">Qté</th>
                  <th style={{ backgroundColor: wizardData.formatting.primaryColor }} className="py-1 px-1 text-white text-right rounded-tr-md">Prix</th>
                </tr>
              </thead>
              <tbody>
...
export default Step5Formatting;