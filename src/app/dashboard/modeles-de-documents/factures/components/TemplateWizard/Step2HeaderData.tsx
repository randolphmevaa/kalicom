...
const Step2HeaderData = ({ wizardData, updateWizardData }: WizardStepProps) => {
  const handleHeaderElementChange = (element: string, checked: boolean) => {
    const updatedElements = checked
      ? [...wizardData.headerElements, element]
      : wizardData.headerElements.filter(e => e !== element);
    
    updateWizardData({ headerElements: updatedElements });
  };
            ...
            <div className="space-y-3">
              <label className="flex items-center space-x-2">
                <input 
                  ...
                  onChange={(e) => handleHeaderElementChange('logo', e.target.checked)}
                />
              ...
              {[
                ...
                <label key={item.id} className="flex items-center space-x-2">
                  <input 
                    ...
                    onChange={(e) => handleHeaderElementChange(item.id, e.target.checked)}
                  />
...
export default Step2HeaderData;