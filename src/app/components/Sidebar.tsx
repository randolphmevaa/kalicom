...
const sections: Record<string, MenuSection> = {
  ...
  clients: {
    ...
    items: [
      { name: 'Clients', href: '/dashboard/crm/clients', icon: <FiUsers size={20} className="text-white" /> },
    ],
  },
  produits: {
    title: 'Produits',
    ...
    items: [
      { name: 'Produits', href: '/dashboard/crm/produits', icon: <FiBox size={20} className="text-white" /> },
    ],
  },
  documents_ventes: {
    ...
    items: [
      { name: 'Devis', href: '/dashboard/crm/document-ventes/devis', icon: <FiFileText size={20} className="text-white" /> },
      { name: 'Factures', href: '/dashboard/crm/document-ventes/factures', icon: <FiFile size={20} className="text-white" /> },
      { name: 'Avoirs', href: '/dashboard/crm/document-ventes/avoirs', icon: <FiClipboard size={20} className="text-white" /> },
      { name: 'Factures d’acompte', href: '/dashboard/crm/document-ventes/factures-acompte', icon: <FiFileText size={20} className="text-white" /> },
      { name: 'Avoir d’acompte', href: '/dashboard/crm/document-ventes/avoirs-acompte', icon: <FiFile size={20} className="text-white" /> },
    ],
  },
  ...
  parametre_societe: {
    ...
    items: [
      { name: 'Coordonners', href: '/dashboard/crm/parametre-societe/coordonners', icon: <FiMapPin size={20} className="text-white" /> },
      { 
        name: 'Identification', 
        href: '/dashboard/crm/parametre-societe/identification',
        icon: <FiUser size={20} className="text-white" />,
        subItems: [
          { name: 'Informations administratives', href: '/dashboard/crm/parametre-societe/identification/infos-administratives', icon: <FiInfo size={16} className="text-white" /> },
          { name: 'Informations TVA', href: '/dashboard/crm/parametre-societe/identification/informations-tva', icon: <FiPercent size={16} className="text-white" /> },
        ],
      },
      { name: 'Logo', href: '/dashboard/crm/parametre-societe/logo', icon: <FiImage size={20} className="text-white" /> },
      { name: 'Numerotation', href: '/dashboard/crm/parametre-societe/numerotation', icon: <FiHash size={20} className="text-white" /> },
      { name: 'Mentions legales des devis', href: '/dashboard/crm/parametre-societe/mentions-devis', icon: <FiFileText size={20} className="text-white" /> },
      { name: 'Mentions legales des factures', href: '/dashboard/crm/parametre-societe/mentions-factures', icon: <FiFile size={20} className="text-white" /> },
      { name: 'Taxes', href: '/dashboard/crm/parametre-societe/taxes', icon: <FiPercent size={20} className="text-white" /> },
      { name: 'Banque', href: '/dashboard/crm/parametre-societe/banque', icon: <FiCreditCard size={20} className="text-white" /> },
    ],
  },
  modeles_de_documents: {
    ...
    items: [
      { name: 'Factures', href: '/dashboard/crm/modeles-de-documents/factures', icon: <FiFile size={20} className="text-white" /> },
      { name: 'Devis', href: '/dashboard/crm/modeles-de-documents/devis', icon: <FiFileText size={20} className="text-white" /> },
      { name: 'Avoirs', href: '/dashboard/crm/modeles-de-documents/avoirs', icon: <FiClipboard size={20} className="text-white" /> },
      { name: 'Factures d’acompte', href: '/dashboard/crm/modeles-de-documents/factures-acompte', icon: <FiFileText size={20} className="text-white" /> },
      { name: 'Avoir d’acompte', href: '/dashboard/crm/modeles-de-documents/avoirs-acompte', icon: <FiFile size={20} className="text-white" /> },
    ],
  },
  modeles: {
    title: 'Modèles',
    ...
    items: [
      { name: 'Email', href: '/dashboard/crm/modeles/email', icon: <FiMail size={20} className="text-white" /> },
      { name: 'SMS', href: '/dashboard/crm/modeles/sms', icon: <FiMessageSquare size={20} className="text-white" /> },
    ],
  },
  utilisateurs: {
    title: 'Utilisateurs',
